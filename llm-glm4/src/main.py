...
HOME='/workspace/PythonProject'
CHAT_MODEL_PATH = os.environ.get("CHAT_MODEL_PATH", f"{HOME}/THUDM/glm-4-9b-chat")
VLM_MODEL_PATH = os.environ.get("VLM_MODEL_PATH", f"{HOME}/THUDM/glm-4v-9b")
    ...
    if first_round:
        ...
        if uploaded_files and not st.session_state.files_uploaded:
            ...
            for uploaded_file in uploaded_files:
                ...
                file_path = os.path.join("/temp", random_file_name + file_extension)
